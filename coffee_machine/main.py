...
def process_coins(req_amount):
    ...
    value += coins_provided["quarters"] * COIN_VALUES["quarter"]
    value += coins_provided["dimes"] * COIN_VALUES["dime"]
    value += coins_provided["nickles"] * COIN_VALUES["nickle"]
    value += coins_provided["pennies"] * COIN_VALUES["pennie"]

    if value < req_amount:
        enough_money = False
        return value, change, enough_money
    else:
        change = value - req_amount
        enough_money = True
        return value, change
